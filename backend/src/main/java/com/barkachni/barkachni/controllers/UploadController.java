...
import com.barkachni.barkachni.Services.blog.CloudinaryService;
import com.barkachni.barkachni.Services.blog.PostServiceImplement;
...
public class UploadController {
    ...
    @Autowired
    @Qualifier("cloudinaryServiceblog")
